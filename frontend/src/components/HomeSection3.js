  ...
  return (
    <div className="homesection3">
      <div className="container">
        <div className="card">
          <div>
            <img  src="https://honeywell.scene7.com/is/image/honeywell/Healthy-Building-Occupant-Survery-Landing-Page_2880x1440_0222_V2_Option01"></img>
          </div>
          <div>
            <div className="cmp-text">
              <h5>
                <b>
                  <span className="label label--secondary">CASE STUDY&nbsp;</span>
                </b>
              </h5>
              <h4>
        ...
        <div className="card">
          <div>
            <img  url="https://picsum.photos/800/600?random=1"></img>
          </div>
          <div>
            <div className="cmp-text">
              <h5>
